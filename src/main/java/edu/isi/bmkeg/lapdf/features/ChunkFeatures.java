...
public class ChunkFeatures {
	...
	public boolean isMostPopularFontModifierBold() {
		if(chunk.getMostPopularWordStyle() != null) {
			System.out.println("WordStyle: " + chunk.getMostPopularWordStyle());
		}
		
		if(chunk.getMostPopularWordFont() != null) {
			System.out.println("WordFont: " + chunk.getMostPopularWordFont());
		}
